...
const QUIZ_BANK = {
  ...
  cft_program: {
    ...
    questions: [
      ...
      { q: 'What does the "F" in the FORM conversation framework stand for?', options: ['Finances', 'Family', 'Follow-up', 'Fear'], answer: 1, explain: 'FORM = Family, Occupation, Recreation, Message — a natural way to build rapport before transitioning to your message.' },
      { q: 'In the Free, Future, Present close, what happens in the "Present" step?', options: ['You ask if they can see themselves doing this part time', 'You explain the future licensing process', 'You close on getting started today and the platform fee due now', 'You present the compensation plan in detail'], answer: 2, explain: '"Present" is where they commit today and pay the platform fee — a simple close usable by someone with zero sales experience.' },
      { q: 'In the "3 Ways Money Grows" framework, which option is safe AND tracks market upside without the downside?', options: ['Variable (stock market)', 'Fixed (bank/CD)', 'Indexed (IUL)', 'None of them'], answer: 2, explain: 'Indexed accounts (like an IUL) offer a 0% floor with capped upside tied to an index like the S&P — safety of Fixed with growth potential closer to Variable.' },
      { q: 'In the "5 Homes of Money" framework, which home typically scores highest across liquidity, safety, tax advantage, and growth combined?', options: ['Banks', 'Stock Market', 'Qualified Plans (401k/IRA)', 'Life Insurance'], answer: 3, explain: 'Life Insurance is framed as scoring well across all 5 factors — liquidity, safety of principal, tax deduction, tax advantage, and growth — versus the other 4 "homes."' },
      { q: 'According to the market-opportunity script, what is the real challenge in this industry?', options: ['There are too many clients and not enough leads', 'Finding enough trained financial professionals to serve an underinsured population', 'The product portfolio is too limited', 'Licensing takes too long'], answer: 1, explain: 'With 340M+ Americans, 11,000+ turning 65 daily, and only 250,000 active licensed agents, the bottleneck is trained professionals — not demand.' },
    ]
  },
